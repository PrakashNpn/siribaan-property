  ...
  return (
    <>
      ...
      <section className="pt-6 pb-12 md:py-12 bg-blue-50 relative">
        {/* Ambient orbs — clipped so they don't cause horizontal overflow */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2 space-y-10 md:space-y-16">
              ...
              <div>
                ...
                <h1
                  className="text-3xl md:text-4xl font-bold text-[#125DE5] mb-5 leading-tight"
                                 >
                  {property.title}
                </h1>
                ...
                <div className="flex flex-wrap gap-2.5 mb-5">
                  {bedroomSet.length > 0 && (
                    <div className="flex items-center gap-3 bg-white/70 backdrop-blur-sm border border-blue-100/70 rounded-2xl px-4 py-3 shadow-[0_2px_16px_rgba(18,93,229,0.07)]">
                      <div className="w-8 h-8 rounded-full bg-[#125DE5]/10 flex items-center justify-center shrink-0">
                        <Bed size={14} className="text-[#125DE5]" />
                      </div>
                      <div>
                  ...
                  {bathroomSet.length > 0 && (
                    <div className="flex items-center gap-3 bg-white/70 backdrop-blur-sm border border-blue-100/70 rounded-2xl px-4 py-3 shadow-[0_2px_16px_rgba(18,93,229,0.07)]">
                      <div className="w-8 h-8 rounded-full bg-[#125DE5]/10 flex items-center justify-center shrink-0">
                        <Bath size={14} className="text-[#125DE5]" />
                      </div>
                      <div>
                  ...
                  {areaMin !== null && (
                    <div className="flex items-center gap-3 bg-white/70 backdrop-blur-sm border border-blue-100/70 rounded-2xl px-4 py-3 shadow-[0_2px_16px_rgba(18,93,229,0.07)]">
                      <div className="w-8 h-8 rounded-full bg-[#125DE5]/10 flex items-center justify-center shrink-0">
                        <Square size={14} className="text-[#125DE5]" />
                      </div>
                      <div>
                  ...
                  <div className="flex items-center gap-3 bg-white/70 backdrop-blur-sm border border-blue-100/70 rounded-2xl px-4 py-3 shadow-[0_2px_16px_rgba(18,93,229,0.07)]">
                    <div className="w-8 h-8 rounded-full bg-[#125DE5]/10 flex items-center justify-center shrink-0">
                      <Home size={14} className="text-[#125DE5]" />
                    </div>
                    <div>
                ...
                {startingPrice !== null && (
                  <div>
                    ...
                    <p className="text-3xl font-bold text-[#125DE5]">฿{formatPrice(startingPrice)}</p>
                  </div>
                )}
              </div>
                ...
                {(property.totalFloors || property.totalUnits || property.yearBuilt || property.completionDate || property.landAreaSqm) && (
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
                    {property.totalFloors && (
                      <div className="bg-white/60 border border-white/80 rounded-xl px-4 py-3 flex items-center gap-3">
                    ...
                    {property.unitTypes.map((unit, i) => (
                      ...
                      >
                        <div className="flex flex-col sm:flex-row sm:items-center sm:divide-x divide-gray-100/80">
                          ...
                          {/* Identity */}
                          <div className="flex items-center gap-4 pl-0 pr-6 py-4 sm:py-5 sm:min-w-[190px]">
                            <div className="w-1 self-stretch bg-[#125DE5] rounded-r-full shrink-0" />
                            <span className="text-4xl font-bold text-gray-200 leading-none select-none shrink-0">
                          ...
                          {/* Stats chips */}
                          <div className="flex items-center gap-2 px-5 sm:px-6 py-3 sm:py-5 flex-1 flex-wrap border-t border-gray-100/80 sm:border-t-0">
                          ...
                          {/* Price */}
                          <div className="px-5 sm:px-6 py-3 sm:py-5 sm:text-right sm:min-w-[170px] sm:shrink-0 border-t border-gray-100/80 sm:border-t-0">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {property.amenities.map((amenity) => (
                      <div key={amenity} className="flex items-center gap-4 bg-white/70 backdrop-blur-sm rounded-2xl px-4 py-3.5 border border-blue-100/70 shadow-[0_2px_12px_rgba(18,93,229,0.05)]">
                        <div className="w-8 h-8 rounded-full bg-[#125DE5]/10 flex items-center justify-center shrink-0">
              ...
              <div>
                ...
                <MapEmbed address={property.address} height="h-80" />

                {/* Address + CTA row */}
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mt-4 bg-white/70 backdrop-blur-sm border border-blue-100/70 rounded-2xl px-5 py-4 shadow-[0_2px_12px_rgba(18,93,229,0.05)]">
