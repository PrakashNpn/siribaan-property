      ...
      <div className="relative z-10 w-full max-w-md text-center">
        <div className="relative rounded-2xl border border-white/70 overflow-hidden shadow-[0_8px_40px_rgba(18,93,229,0.12)] px-8 py-12">
          ...
          <div className="relative z-10">
            ...
            >
              Properties Could Not<br />
              <span className="italic text-[#125DE5]">Be Retrieved</span>
            </h2>
            <p className="text-gray-500 text-sm leading-relaxed mb-8">
              We had trouble loading the property listings. Please try again or browse our other pages.
            </p>
